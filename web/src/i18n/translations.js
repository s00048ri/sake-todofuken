...
export const STRINGS = {
  ja: {
    ...
    perCapita: {
      ...
      modeOff: '絶対量',
      modeTotal: '1人あたり（総人口）',
      modeAdult: '15歳以上1人あたり',
      modeAdultShort: '成人1人あたり',
      adultUnavailable: '15歳以上人口データは2020-2024年のみ（それ以前は総人口で表示）',
      noteTotal: '都道府県の総人口で割った値。観光客等の県外流入は反映されません。',
      noteAdult: '15歳以上人口で割った値（飲酒可能年齢の近似）。2020-2024年のみ。',
      unit: 'L/人',
      unitAdult: 'L/成人',
    },
    explore: {
  ...
  en: {
    ...
    perCapita: {
      label: 'Per capita',
      modeOff: 'Absolute',
      modeTotal: 'Per capita (total pop.)',
      modeAdult: 'Per 15+ adult',
      modeAdultShort: 'Per adult',
      adultUnavailable: '15+ population data is only available 2020-2024 (earlier years fall back to total population)',
      noteTotal: 'Divided by prefectural population. Tourist/transient consumption is not reflected.',
      noteAdult: 'Divided by 15+ population (approximation of drinking-age population). 2020-2024 only.',
      unit: 'L/person',
      unitAdult: 'L/adult',
    },
    explore: {
